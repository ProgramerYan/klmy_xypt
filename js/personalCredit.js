var chartP5L1 = echarts.init(document.getElementById('chartP5L1'));
	...
	function loadDataByYear(year){	
		...
		load_table_ZDRQ(table_ZDRQXQ_DataSourceId);
	}
	...
	//
    function load_table_ZDRQ(datasourceid)
	{
		var tableDataSourceID=datasourceid;
	...
	function initChart_SXRK_BR()
	{
		 chartP5B3.setOption({
			...
			color: ['rgb(195,52,48)','rgb(213,131,100)','rgb(159,231,185)','rgb(96,161,169)','rgb(46,68,84)'],
